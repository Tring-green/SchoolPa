...
public interface SPDB {
	...
	public interface Account {
		...
		String SQL_CREATE_TABLE = "create table " + TABLE_NAME + " ("
				...
				+ COLUMN_USERID + " text," + COLUMN_NAME + " text,"
	...
	public interface Friend {
		...
		String SQL_CREATE_TABLE = "create table " + TABLE_NAME + " ("
				+ COLUMN_ID + " integer primary key autoincrement, "
				+ COLUMN_OWNER + " text," + COLUMN_USERID + " text,"
	...
	public interface Invitation {
		...
		String COLUMN_ID = "_id";
		String COLUMN_OWNER = "owner";
		String COLUMN_INVITATOR_USERID = "invitator_userId";// 邀请者的黑信号
		...
		String SQL_CREATE_TABLE = "create table " + TABLE_NAME + " ("
				+ COLUMN_ID + " integer primary key autoincrement, "
				+ COLUMN_OWNER + " text," + COLUMN_INVITATOR_USERID + " text,"
